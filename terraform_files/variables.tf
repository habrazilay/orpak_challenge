...
variable "public_subnet_cidrs" {
  ...
  type        = list(string)
  default     = ["10.0.1.0/24", "10.0.3.0/24"] # Adjust based on the number of availability zones
}

variable "private_subnet_cidrs" {
  description = "List of CIDR blocks for the private subnets"
  type        = list(string)
  default     = ["10.0.2.0/24", "10.0.4.0/24"] # Adjust based on the number of availability zones
}
